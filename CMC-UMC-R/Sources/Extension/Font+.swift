...
extension FontStyle {
    ...
    static let display3 = FontStyle(font: .custom("Pretendard-Bold", size: 16), fontName: "Pretendard-Bold", size: 16, lineHeight: 16 * 1.5)
    ...
    static let main4 = FontStyle(font: .custom("Pretendard-Medium", size: 32), fontName: "Pretendard-Medium", size: 32, lineHeight: 32 * 1.5)
